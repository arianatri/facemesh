    ...
    */
    ...
    I("Promise", function (a) {
        ...
        b.all = function (f) {
            var h = J(f),
                k = h.next();
            return k.done ? d([]) : new b(function (l, r) {
                function w(A) {
                    return function (n) {
                        x[A] = n;
                        v--;
                ...
                var x = [],
                    v = 0;
                do x.push(void 0), v++, d(k.value).I(w(x.length - 1), r), k = h.next(); while (!k.done)
            })
        };
        return b
    });
    ...
    function U(a, b, c) {
        if (null != c) {
            ...
            var d = c;
            d = (c = 0 > d ? 1 : 0) ? -d : d;
            0 === d ? 0 < 1 / d ? Q = R = 0 : (R = 0, Q = 2147483648) : isNaN(d) ? (R = 0, Q = 2147483647) : 3.4028234663852886E38 < d ? (R = 0, Q = (c << 31 | 2139095040) >>> 0) : 1.1754943508222875E-38 > d ? (d = Math.round(d / Math.pow(2, -149)), R = 0, Q = (c << 31 | d) >>> 0) : (b = Math.floor(Math.log(d) / Math.LN2), d *= Math.pow(2, -b), d = Math.round(8388608 * d) & 8388607, R = 0, Q = (c << 31 | b + 127 << 23 | d) >>> 0);
            c = Q;
            a.push(c >>> 0 & 255);
            a.push(c >>> 8 & 255);
            a.push(c >>> 16 & 255);
    ...
    function V(a, b, c, d) {
        ...
        if (c)
            for (b = 0; b < c.length; b++) a = c[b], a < this.l ? (a += this.j, (e = this.h[a]) ? ab(e) : this.h[a] = eb) : (fb(this), (e = this.i[a]) ? ab(e) : this.i[a] = eb);
        if (d && d.length)
    ...
    function lb(a, b) {
        if (a.g)
            for (var c in a.g) {
                var d = a.g[c];
                if (Array.isArray(d))
                    for (var e = 0; e < d.length; e++) d[e] && lb(d[e], b);
                else d && lb(d, b)
            }
        return a.h
    }
    ...
    function Ib(a) {
        return jb(a, sb).map(function (b) {
            return {
                index: hb(b, 1, 0),
                W: Y(b, 2),
                label: null != W(b, 3) ? hb(b, 3, "") : void 0,
                displayName: null != W(b, 4) ? hb(b, 4, "") : void 0
            }
        })
    };
    ...
    function Mb(a, b) {
        ...
        if (void 0 === a.m) {
            ...
            a.i = {
                H: c.getAttribLocation(d, "aVertex"),
                G: c.getAttribLocation(d, "aTex"),
                ba: e
            };
            a.s = c.createBuffer();
        ...
        return Z(a, function c() {
            ...
            return O(c, function (n) {
                switch (n.g) {
                    ...
                    case 2:
                        f = n.h;
                        if ("object" === typeof window) return Qb("createMediapipeSolutionsWasm", {
                            locateFile: d.locateFile
                        }), Qb("createMediapipeSolutionsPackedAssets", {
                            locateFile: d.locateFile
                        }), l = g.filter(function (u) {
                            return void 0 !== u.data
                        }), r = g.filter(function (u) {
                            return void 0 === u.data
                        }), w = Promise.all(l.map(function (u) {
                            var y = Wb(e, u.url);
                            if (void 0 !==
                                u.path) {
                                var z = u.path;
                            ...
                            return y
                        })), x = Promise.all(r.map(function (u) {
                            ...
                            return Z(e, function y() {
                                ...
                                return O(y, function (D) {
                                    z.g.graph &&
                                        z.g.graph.url ? D = N(D, Wb(z, z.g.graph.url), 0) : (D.g = 0, D = void 0);
                                    return D
                                })
                            })
    ...
    function Xb(a) {
        return Z(a, function c() {
            ...
            return O(c, function (x) {
                ...
                d.A = {};
                if (d.g.listeners)
                    for (k = J(d.g.listeners), l = k.next(); !l.done; l = k.next()) r = l.value, Yb(d, r);
                w = d.j;
                d.j = {};
                d.setOptions(w);
                x.g = 0
    ...
    t.setOptions = function (a, b) {
        ...
        if (b = b || this.g.options) {
            for (var d = [], e = [], g = {}, f = J(Object.keys(a)), h = f.next(); !h.done; g = {
                    J: g.J,
                    K: g.K
                }, h = f.next()) {
                var k = h.value;
                k in this.j && this.j[k] === a[k] || (this.j[k] = a[k], h = b[k], void 0 !== h && (h.onChange && (g.J = h.onChange, g.K = a[k], d.push(function (l) {
                    return function () {
                    ...
                    case 3:
                        ...
                        for (k = h.next(); !k.done; k = h.next())
                            if (l = k.value, r = e.g.inputs[l]) {
                                    ...
                                    switch (r.type) {
                                        ...
                                        case "detections":
                                            ...
                                            for (y = 0; y < u.length; ++y) {
                                                ...
                                                F.call(D, E, G);
                                                if (z.M)
                                                    for (D = 0; D < z.M.length; ++D) q = z.M[D], m = q.visibility ? !0 : !1, F = n.data, E = F.addNormalizedLandmark, G = y, q = Object.assign(Object.assign({}, q), {
                                                            visibility: m ? q.visibility : 0
                                                        }), m = new wb, X(m, 1, q.x), X(m, 2, q.y), X(m, 3, q.z), q.visibility && X(m, 4, q.visibility),
                                                        q = new Va, B = m, p = q, m = W(B, 1), null != m && U(p, 1, m), m = W(B, 2), null != m && U(p, 2, m), m = W(B, 3), null != m && U(p, 3, m), m = W(B, 4), null != m && U(p, 4, m), m = W(B, 5), null != m && U(p, 5, m), q = Wa(q), E.call(F, G, q);
                                                if (z.L)
                                ...
                                switch (r.type) {
                                    case "video":
                                        f.pushTexture2d(Object.assign(Object.assign({}, w), {
                                            stream: x,
                                            timestamp: g
                                        }));
                                        break;
                    ...
                    case 2:
                        ...
                        if ("detection_list" === A.type) {
                            if (n) {
                                var E = n.getRectList();
                                for (var G =
                                        n.getLandmarksList(), q = n.getClassificationsList(), B = [], m = 0; m < E.size(); ++m) {
                                    var p = E.get(m);
                                    a: {
                                        var H = new Bb;
                                        for (p = new La(p); S(p);) switch (p.i) {
                                            case 13:
                                                var K = T(p);
                                                X(H, 1, K);
                                                break;
                                    ...
                                    var la = q.get(m);
                                    a: for (K = new ub, la = new La(la); S(la);) switch (la.i) {
                                        case 10:
                                            var ob =
                                                new sb;
                                            Na(la, ob, tb);
    ...
    function Yb(a, b) {
        ...
        g = a.h.PacketListener.implement({
            onResults: function (h) {
                ...
                var r = a.listeners[c];
                r && (a.B = $b(a, k, b.outs).then(function (w) {
                    w = r(w);
